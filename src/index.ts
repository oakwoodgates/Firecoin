...
async function main() {
  ...
  const mint = new web3.PublicKey("CywzLYpKBuCwZKLBWH764bSoLbN6zUiscJH1ViZfCdEA")

  // Create a token account for our address
  ...
  const receiver = new web3.PublicKey("J97KxAfxFDmp6Ctmb9QWnqGR4vasFxJ8mqVDXoq1MjpT")
